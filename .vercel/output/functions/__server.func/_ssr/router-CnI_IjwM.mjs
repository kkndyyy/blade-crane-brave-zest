...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CnI_IjwM.js
var router_CnI_IjwM_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BZ4tCTGR.css";
var APP_NAME = "헬포지";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "디아블로 II 레저렉션 · 엽굵 모드 MPQ 작업대"
			},
			{
				name: "theme-color",
				content: "#0c0a09"
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
				...
				toastOptions: { className: "font-sans bg-bg-elevated text-fg border-border" }
			})] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})
		] })]
	})
});
var $$splitComponentImporter = () => import("./routes-PDTLLPjP.mjs");
...
//#endregion
export { getRouter, router_CnI_IjwM_exports as t };
